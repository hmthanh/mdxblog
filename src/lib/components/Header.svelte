<script>
  import CameraIcon from "scope-core/Icons/Camera.svelte"
</script>
...
<header class="nextra-nav-container sticky top-0 z-20 w-full bg-transparent print:hidden">
  <div
    class="nextra-nav-container-blur pointer-events-none absolute z-[-1] h-full w-full bg-white dark:bg-dark shadow-[0_2px_4px_rgba(0,0,0,.02),0_1px_0_rgba(0,0,0,.06)] dark:shadow-[0_-1px_0_rgba(255,255,255,.1)_inset] contrast-more:shadow-[0_0_0_1px_#000] contrast-more:dark:shadow-[0_0_0_1px_#fff]"
  ></div>
  <nav
