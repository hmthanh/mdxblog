...
import type { DynamicMetaDescriptor, MdxPath, PageMapItem } from "./types"


const filterRouteLocale = (items, locale, defaultLocale) => {}
...
const cachedDynamicMetaForLocale: Record<string, [DynamicMetaDescriptor[], PageMapItem[]]> = Object.create(null)
