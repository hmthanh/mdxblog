...
//   let currentIndex = resolvers.resolveActiveIndex() ?? -1
...
//           if (currentIndex !== -1 && all.length - idx - 1 >= currentIndex) return false
...
//     default:
//       throw new Error("Unexpected focus type: " + action.focus)
//   }
