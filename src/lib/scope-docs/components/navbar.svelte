...
<div class="nextra-nav-container sticky top-0 z-20 w-full bg-transparent print:hidden">
  ...
  />
  <nav
    class="mx-auto flex h-[var(--nextra-navbar-height)] max-w-[90rem] items-center justify-end gap-2 pl-[max(env(safe-area-inset-left),1.5rem)] pr-[max(env(safe-area-inset-right),1.5rem)]"
  >
    <a class="flex items-center hover:opacity-75 ltr:mr-auto rtl:ml-auto" href="/"
      ><svg height="20" viewBox="0 0 361 70" fill="none" xmlns="http://www.w3.org/2000/svg" class="jsx-37c7cf7a4c4dcf24"
        ><path
    ...
    ><a
      ...
      aria-current="true"
      href="/"
      ><span class="absolute inset-x-0 text-center">Documentation</span><span class="invisible font-medium"
        >Documentation</span
      ></a
    ><a
      ...
      aria-current="false"
      href="/"
      ><span class="absolute inset-x-0 text-center">Showcase</span><span class="invisible font-medium">Showcase</span
      ></a
    ><a
      class="text-sm contrast-more:text-gray-700 contrast-more:dark:text-gray-100 relative -ml-2 hidden whitespace-nowrap p-2 md:inline-block text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200"
      aria-current="false"
      href="/"
      ><span class="absolute inset-x-0 text-center">About</span><span class="invisible font-medium">About</span></a
    >
    <div class="nextra-search relative md:w-64 hidden md:inline-block mx-min-w-[200px]">
      <div
      ...
      >
        <input
          ...
          value=""
        /><kbd
          class="absolute my-1.5 select-none ltr:right-1.5 rtl:left-1.5 h-5 rounded bg-white px-1.5 font-mono text-[10px] font-medium text-gray-500 border dark:border-gray-100/20 dark:bg-dark/50 contrast-more:border-current contrast-more:text-current contrast-more:dark:border-current items-center gap-1 transition-opacity pointer-events-none hidden sm:flex opacity-100"
          >CTRL K</kbd
        >
      </div>
    </div>
    <a href="https://github.com/shuding/nextra" target="_blank" rel="noreferrer" class="p-2 text-current"
      ><svg width="24" height="24" fill="currentColor" viewBox="3 3 18 18"
        ...
        ></path></svg
      ><span class="sr-only">GitHub</span><span class="sr-only select-none"> (opens in a new tab)</span></a
    ><button type="button" aria-label="Menu" class="nextra-hamburger -mr-2 rounded p-2 active:bg-gray-400/20 md:hidden"
      ><svg fill="none" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" class=""
        ><g><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16"></path></g><path
          stroke-linecap="round"
          stroke-linejoin="round"
          stroke-width="2"
          d="M4 12h16"
        ></path><g><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 18h16"></path></g></svg
      ></button
    >
  </nav>
