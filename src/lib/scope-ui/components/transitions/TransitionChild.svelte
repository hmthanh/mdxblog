...
<script lang="ts">
  ...
  import { Reason, transition } from "scope-ui/utils/transition"
  import type { NestingContextValues } from "scope-ui/components/transitions/common.svelte"
  import {
    hasChildren,
  ...
  import { Features, type TRestProps } from "scope-ui/types"
