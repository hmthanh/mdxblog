<script lang="ts" context="module">
  import type { useId } from "scope-ui/hooks/use-id"
  import { match } from "scope-ui/utils/match"
  import { RenderStrategy } from "scope-ui/utils/Render.svelte"
  ...
  export function useTransitionContext(): Readable<TransitionContextValues> {
    let context = getContext(TRANSITION_CONTEXT_NAME) as Writable<TransitionContextValues> | undefined
