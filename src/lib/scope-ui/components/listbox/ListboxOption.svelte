<script lang="ts" context="module">
  ...
  type TListboxOptionProps<TSlotProps extends {}, TAsProp extends SupportedAs> = Omit<
...
<script lang="ts">
  ...
  $: active = $api.activeOptionIndex !== null ? $api.options[$api.activeOptionIndex].id === id : false
