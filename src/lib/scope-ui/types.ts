...
export type TRestProps<T> = T extends SupportedElement ? Omit<svelteHTML.IntrinsicElements[T], "class" | "style"> : {}

export type TResolveAs<TAsProp, TDefaultAs> = SupportedAs extends TAsProp ? TDefaultAs : TAsProp

export type THTMLProps<TSlotProps extends {}, TAsProp extends SupportedAs> = {
  name: string
...
type BaseProps<TSlotProps extends {}, TAsProp extends SupportedAs, TDefaultAs> = {
  name: string
  slotProps: TSlotProps
  el?: HTMLElement | null
  visible?: boolean
...
export type TRenderProps<TSlotProps extends {}, TAsProp extends SupportedAs, TDefaultAs> = BaseProps<
  TSlotProps,
  TAsProp,
  TDefaultAs
> & {
...
export type TPassThroughProps<TSlotProps extends {}, TAsProp extends SupportedAs, TDefaultAs> = Omit<
