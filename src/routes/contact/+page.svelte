<script>
  ...
  import WireIcon from "$lib/core/Icons/Wire.svelte"
  import TelegramIcon from "$lib/core/Icons/Telegram.svelte"
    ...
    <ul>
      ...
      <li>
        <span class="icon"><FacebookIcon /></span><ExternalLink
          ariaLabel="D M Mdx Blog on Facebook Messenger"
      ...
      <li>
        <span class="icon"><TwitterIcon /></span><ExternalLink
          ariaLabel="D M Mdx Blog on Twitter"
      ...
      <li>
        <span class="icon"><TelegramIcon /></span><ExternalLink
          ariaLabel="Message Mdx Blog on Telegram"
